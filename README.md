# Logica de Programação - Desafios

Repositório dedicado à resolução de problemas de lógica de programação, focado em algoritmos e estruturas de dados competitivos.

---

### 🛠️ Tecnologias e Ferramentas
* **Linguagem Principal:** ![[C](https://shields.io)](https://img.shields.io/badge/logo-C-blue?logo=c)
* **Plataformas:** 
...
O repositório está organizado por pastas representando cada plataforma de juiz online:

*   `./TheHuxley`: Problemas resolvidos no TheHuxley.
*   `./Beecrowd`: Problemas resolvidos no Beecrowd.

---

### 📊 Tabela de Desafios

Aqui listo os problemas resolvidos para facilitar a busca por tema:


| Plataforma | ID | Título | Solução | Status |
| :--- | :---: | :--- | :---: | :---: |
| TheHuxley | 3362 | A fórmula de Janaína | [C](./TheHuxley/3362.c) | done |
...
📫 **Contatos:**
Gabriel Arthur Santos Villarejos - [Linkedin](in/gabriel-villarejos-3688802b7)
